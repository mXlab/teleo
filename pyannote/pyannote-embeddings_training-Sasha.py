...
class SpeakerEmbeddingDataset(Dataset):
    def __init__(self, file_paths, labels, sample_rate=16000, chunk_duration=1, chunk_overlap=0):
...
# Create the dataset
dataset = SpeakerEmbeddingDataset(file_paths, labels, chunk_duration=dataset_chunk_duration_val, chunk_overlap=dataset_chunk_overlap_val)
