...
parser.add_argument("--k-nearest-neighbors", '-k', type=int, default=10, help="Number of nearest neighbors.")
...
known_speakers = ['Victor', 'Sofian', 'Etienne', 'Natalia']
unknown_speakers = ['Sasha', 'Vincent', 'Marianne']
